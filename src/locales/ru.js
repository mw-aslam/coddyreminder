module.exports = {
  ...
  help_text: "📖 *Coddy Reminder — Руководство по командам*\n\n⏰ *Напоминания:*\n• /reminder — Создать новое напоминание (пошагово)\n• /myreminders — Посмотреть и изменить мои напоминания\n• /delete — Быстрое удаление напоминаний\n• 🎙 *Голос и текст:* Напишите или скажите голосом: `сегодня в 15:28 демодей`\n\n📝 *Задачи и Привычки:*\n• `/todo Купить продукты` — Добавить задачу в чек-лист\n• `/habits Чтение 30 мин` — Добавить привычку (трекер серии 🔥)\n\n📅 *Экспорт и Группы:*\n• /export — Экспортировать напоминания в Календарь (.ics)\n• /groups — Посмотреть подключённые группы\n• /settings — Язык и авто-удаление сообщений\n• /cancel — Отменить текущее действие",
